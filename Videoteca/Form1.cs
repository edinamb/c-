...
namespace Videoteca
{
    public partial class Form1 : Form
    {
        ...
        string[] imagini = { "Titanic.jpg", "Don_Juan_de_Marco.jpg", "Tom_Jerry.jpg", "The_Matrix_Poster.jpg", "Letters_to_Juliet.jpg" };
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                label5.Text = "Ati inchiriat filmul " + filmul.SelectedItem.ToString() + " pentru " + nrzile + " zile";
            }
        }
        ...
        private void filmul_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // aceasta "..\\..\\..\\poze\\" este calea relativa spre folderul in care sunt pastrate imaginile
